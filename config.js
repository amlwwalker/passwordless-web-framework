...
config.mongodb.database = process.env.MONGODB_DATABASE || 'frame-work';
...
config.http.host_url = process.env.HTTP_HOST_URL || 'http://localhost:3000';
...
config.mandrill.from = process.env.MANDRILL_FROM || 'framework@drobpox.co.uk';
config.mandrill.fromname = process.env.MANDRILL_FROMNAME || 'Frame-work'
config.mandrill.api_key = process.env.MANDRILL_API_KEY || '4DZwE4PCZAIqeew9T0gL8g';
config.mandrill.subject = process.env.MANDRILL_SUBJECT || 'AUTH LOGIN!';
